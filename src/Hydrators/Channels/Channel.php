...
final class Channel extends DevicesHydrators\Channels\Channel
{
	...
	): Entities\Devices\Device
	{
		...
		throw new JsonApiExceptions\JsonApiError(
			...
			$this->translator->translate('//viera-connector.base.messages.invalidRelation.heading'),
			$this->translator->translate('//viera-connector.base.messages.invalidRelation.message'),
			[
